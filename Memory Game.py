...
def display_start_screen():
    ...
    main_msg = game_font_kr.render(f"기억력 테스트 게임", True, WHITE)
    main_msg_rect = main_msg.get_rect(center=(screen_width / 2, screen_height / 2))
    if curr_level == 1:
...
game_font_kr = pygame.font.SysFont('gulim', 60)
...
# 숫자 숨김 여부 (사용자를 1을 클릭했거나, 보여주는 시간 초과했을 때)
hidden = False
